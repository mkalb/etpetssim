...
public final class EtpetsBalance {
    ...
    public static final int TRAIL_INTENSITY_INITIAL = 10;
    ...
    public static final int PET_EGG_INCUBATION_REMAINING_MAX = 15;
    ...
    public static final int PET_TRAIL_PREFERENCE_THRESHOLD = 1_000;
