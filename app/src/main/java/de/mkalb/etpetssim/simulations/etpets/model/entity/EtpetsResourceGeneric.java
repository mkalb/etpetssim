...
public abstract sealed class EtpetsResourceGeneric implements EtpetsResourceEntity
        permits EtpetsResourcePlant, EtpetsResourceInsect {

    private final double maxAmount;
    private final double regenerationPerStep;
    private double currentAmount;

    protected EtpetsResourceGeneric(double currentAmount, double maxAmount, double regenerationPerStep) {
