...
public final class ReboundingMovingEntity implements ReboundingEntity {

    private CompassDirection direction;

    public ReboundingMovingEntity(CompassDirection direction) {
