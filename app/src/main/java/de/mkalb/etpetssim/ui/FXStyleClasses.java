...
public final class FXStyleClasses {
    ...
    public static final String OBSERVATION_CHART = "observation-chart";
    public static final String OBSERVATION_CHART_SECTION = "observation-chart-section";
    ...
    public static final String SIMULATION_EDIT_TOOLBAR = "simulation-edit-toolbar";
    public static final String SIMULATION_EDIT_TOOLBAR_BUTTON = "simulation-edit-toolbar-button";
