...
- Keep domain terms when they are the domain name (`Fish`, `Shark`, `Ant`, `Pet`, `MovingEntity`, `SnakeHead`).
...
- Types not derived from `GridEntity` or `ConstantGridEntity` are left unchanged in this step.

## ET_PETS

| Simulation Type | Java File Name (Class)         | Current FQCN                                                                 | Entity Role          | Java Type Kind | Superclass (`extends`)  | Implemented Interfaces (`implements`)        | Grid Interface Info  | Final Name                |
|-----------------|--------------------------------|------------------------------------------------------------------------------|----------------------|----------------|-------------------------|----------------------------------------------|----------------------|---------------------------|
...
| ET_PETS         | `EtpetsEntityDescribable.java` | `de.mkalb.etpetssim.simulations.etpets.model.entity.EtpetsEntityDescribable` | descriptor           | enum           | -                       | `GridEntityDescribable`                      | none                 | `EtpetsEntityDescribable` |
...
| ET_PETS         | `EtpetsPetGenome.java`         | `de.mkalb.etpetssim.simulations.etpets.model.entity.EtpetsPetGenome`         | value object         | record         | -                       | -                                            | none                 | `EtpetsPetGenome`         |
| ET_PETS         | `EtpetsPetTraits.java`         | `de.mkalb.etpetssim.simulations.etpets.model.entity.EtpetsPetTraits`         | value object         | record         | -                       | -                                            | none                 | `EtpetsPetTraits`         |
...
| WATOR           | `WatorEntityDescribable.java` | `de.mkalb.etpetssim.simulations.wator.model.entity.WatorEntityDescribable` | descriptor           | enum           | -                      | `GridEntityDescribable`                    | none                 | `WatorEntityDescribable` |
| WATOR           | `WatorEntityFactory.java`     | `de.mkalb.etpetssim.simulations.wator.model.entity.WatorEntityFactory`     | factory              | class          | -                      | -                                          | none                 | `WatorEntityFactory`     |
...
| LANGTONS_ANT    | `LangtonAntEntityDescribable.java` | `de.mkalb.etpetssim.simulations.langton.model.entity.LangtonAntEntityDescribable` | descriptor           | enum           | -                      | `GridEntityDescribable`                                        | none                 | `LangtonAntEntityDescribable` |
...
| SUGARSCAPE      | `SugarEntityDescribable.java` | `de.mkalb.etpetssim.simulations.sugar.model.entity.SugarEntityDescribable` | descriptor           | enum           | -                      | `GridEntityDescribable`                     | none                 | `SugarEntityDescribable` |
...
| SNAKE           | `SnakeEntityDescribable.java` | `de.mkalb.etpetssim.simulations.snake.model.entity.SnakeEntityDescribable` | descriptor           | enum           | -                      | `GridEntityDescribable`               | none                 | `SnakeEntityDescribable` |
...
| REBOUNDING_ENTITIES | `ReboundingEntityDescribable.java` | `de.mkalb.etpetssim.simulations.rebounding.model.entity.ReboundingEntityDescribable` | descriptor           | enum           | -                      | `GridEntityDescribable`                  | none                 | `ReboundingEntityDescribable` |
| REBOUNDING_ENTITIES | `ReboundingMovingEntity.java`      | `de.mkalb.etpetssim.simulations.rebounding.model.entity.ReboundingMovingEntity`      | agent                | class          | -                      | `ReboundingEntity`                       | `GridEntity`         | `MovingEntity`                |
